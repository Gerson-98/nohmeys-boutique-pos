...
export default function EditarProductoPage({ params }: Props) {
  ...
  return (
    <div className="space-y-4 max-w-4xl">
      <div>
        <h1 className="font-playfair text-2xl font-bold text-boutique-dark">Editar producto</h1>
        <p className="text-sm text-boutique-gray-mid mt-0.5">{producto?.nombre}</p>
      </div>
      <ProductForm
        modo="editar"
